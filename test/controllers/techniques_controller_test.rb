...
class TechniquesControllerTest < ActionController::TestCase
  ...
  test "should create technique" do
    assert_difference('Technique.count') do
      post :create, technique: { artist_id: @technique.artist_id, description: @technique.description, name: @technique.name }
    end
  ...
  test "should update technique" do
    patch :update, id: @technique, technique: { artist_id: @technique.artist_id, description: @technique.description, name: @technique.name }
    assert_redirected_to technique_path(assigns(:technique))
  end
